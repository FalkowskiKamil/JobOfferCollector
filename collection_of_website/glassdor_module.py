...
def next_page(driver):
    try:
        ...
        next_site_button = driver.find_element(By.XPATH, "/html/body/div[2]/div[2]/div/div/div/div/section/article/div[2]/div/div[1]/button[6]")
        sleep(1)
        next_site_button.click()
        sleep(1)
        return driver
    except:
        loggin_button = driver.find_element(By.XPATH, '//*[@id="LoginModal"]/div/div/div/div[2]/button')
        sleep(1)
        loggin_button.click()
        sleep(1)
